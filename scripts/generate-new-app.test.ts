...
describe('createApp', () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(fs, 'readdir').mockImplementation((dir, cb) => cb(null, ['file1', 'file2']));
  ...
  it('should create a new app directory and copy template files', () => {
    ...
    expect(fs.copyFile).toHaveBeenCalledWith('/fake/dir/_template/file1', '/fake/dir/apps/test-app/file1', expect.any(Function));
    expect(fs.copyFile).toHaveBeenCalledWith('/fake/dir/_template/file2', '/fake/dir/apps/test-app/file2', expect.any(Function));
  });
